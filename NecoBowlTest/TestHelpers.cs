...
{
    public NecoUnitModelCustom_HealthEqualsPower(string name, int health, int power, IReadOnlyCollection<NecoUnitTag> tags, IEnumerable<NecoUnitAction> actions)
        : base()
    {
        Name = name;
        InternalName = name;
    ...
    public NecoUnitModelCustom_HealthEqualsPower(string name, int power, IReadOnlyCollection<NecoUnitTag> tags, IEnumerable<NecoUnitAction> actions)
    ...
    public static NecoUnitModelCustom_HealthEqualsPower Mover(string name, int health, int power, AbsoluteDirection direction)
    {
    ...
    {
        var unit = new NecoUnitModelCustom_HealthEqualsPower(name, power, new NecoUnitTag[] { }, new NecoUnitAction[] { new NecoUnitAction.DoNothing() });
        return unit;
    }

    public static NecoUnitModelCustom_HealthEqualsPower Ball(string name = "TestBall", int power = 1)
    {
        return new NecoUnitModelCustom_HealthEqualsPower(name,
            power,
...
{
    public NecoUnitModelCustom(string name, int health, int power, IReadOnlyCollection<NecoUnitTag>? tags = null, IEnumerable<NecoUnitAction>? actions = null)
    {
    ...
    public NecoUnit ToUnit(NecoPlayer owner) => new NecoUnit(this, owner.Id);
    
    #region Initializers

    public static NecoUnitModelCustom Mover(string? name = null, int health = 1, int power = 1, RelativeDirection direction = RelativeDirection.Up, NecoUnitTag[]? tags = null)
    {
